 ...
 * </p>
 * <ul>
 *   <li>{@link io.entitas.lang.dsl.impl.AliasRuleImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link io.entitas.lang.dsl.impl.AliasRuleImpl#getTypeAlias <em>Type Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AliasRuleImpl extends MinimalEObjectImpl.Container implements AliasRule
{
  ...
  {
    return DslPackage.Literals.ALIAS_RULE;
  }
  ...
  public TargetId getTarget()
  {
    if (target != null && target.eIsProxy())
    {
      ...
      target = (TargetId)eResolveProxy(oldTarget);
      if (target != oldTarget)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DslPackage.ALIAS_RULE__TARGET, oldTarget, target));
      }
    }
    return target;
  }
   ...
   * @generated
   */
  public TargetId basicGetTarget()
  {
    return target;
  }
   ...
   * @generated
   */
  public void setTarget(TargetId newTarget)
  {
    TargetId oldTarget = target;
    target = newTarget;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ALIAS_RULE__TARGET, oldTarget, target));
  }
  ...
  public void setTypeAlias(String newTypeAlias)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.ALIAS_RULE__TYPE_ALIAS, oldTypeAlias, typeAlias));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.ALIAS_RULE__TARGET:
        if (resolve) return getTarget();
        return basicGetTarget();
      case DslPackage.ALIAS_RULE__TYPE_ALIAS:
        return getTypeAlias();
    }
